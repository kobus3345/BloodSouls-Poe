...
class MainGame : ApplicationAdapter() {
    ...
    private lateinit var spriteSheetOne: Texture // This is used to read and make use of my sprite sheet.
    private lateinit var spriteSheetTwo: Texture // This is used to read and make use of my sprite sheet.
    private lateinit var spriteSheetThree: Texture // This is used to read and make use of my sprite sheet.
    private lateinit var idleAnim: TextureRegion // This we use for idle animations.
    ...
    override fun create() {
        ...
        spriteSheetOne = Texture("knight_sprites_idle_one.png")
        //spriteSheetTwo = Texture("knight_sprites_idle_two.png")
        //spriteSheetThree = Texture("knight_sprites_idle_three.png")

        val frameWidth = 128
        val frameHeight = 306
        //val tmpRegions = TextureRegion.split(spriteSheet, frameWidth, frameHeight)

        //Here we use a single texture to create our idle animation.
        idleAnim = TextureRegion(spriteSheetOne)
        ...
        // Here we use the idle animations from the sprite sheet to create an animation loop that will only stop if we start moving.
    ...
    override fun render() {
        ...
        batch.begin()
        batch.draw(idleAnim, playerPosition.x, playerPosition.y, 128f, 306f)
        batch.end()
